...
description: "What to expect during an on-call shift: rotation schedule, response time SLAs, alert triage steps, escalation paths, and shift handoff practices."
---
