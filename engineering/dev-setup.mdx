...
description: "Step-by-step guide to set up your local development environment on a fresh macOS machine, including tooling, repo access, and language runtimes."
---
